...
export function AppShell({ authenticated, canManage = false, children, locale, username = null }: Readonly<{ authenticated: boolean; canManage?: boolean; children: ReactNode; locale: Locale; username?: string | null }>) {
  return <MockAppProvider><div className="app-frame" data-ui="app-shell">
    ...
    <header className="app-header"><div className="header-inner">
      ...
      <HeaderActions authenticated={authenticated} canManage={canManage} locale={locale} username={username}/>
    </div></header>
