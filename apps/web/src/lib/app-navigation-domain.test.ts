...
describe("application navigation domain", () => {
  ...
  it.each([
    [
      { id: "u1", kind: "profile", title: "Maya", subtitle: "@maya", username: "maya" },
      "/users/maya",
    ],
    [
      { id: "p1", kind: "post", title: "Hello", subtitle: "Maya", username: "maya" },
      "/community?room=talk&post=p1",
    ],
    [
      { id: "e1", kind: "event", title: "Trip", subtitle: "Bangkok", username: null },
      "/?marker=e1",
    ],
    [
