...
export default async function ProfileSettingsPage() {
  ...
  const profile: Profile = stored ?? { id: viewer.id, username: viewer.username ?? `driver.${viewer.id.replaceAll("-", "").slice(0, 23)}`, displayName: viewer.displayName, bio: null, location: null, avatarUrl: viewer.avatarUrl, locale, followersCount: 0, followingCount: 0 };
