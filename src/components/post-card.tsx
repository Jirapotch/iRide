  ...
  return (
    <Card className="surface-shadow overflow-hidden border-white/70 bg-card/95 py-0">
      ...
      <CardContent className="space-y-3 px-4 pb-3 sm:px-5">
        ...
        {post.vehicle && <Badge variant="secondary" className="gap-1.5"><Sparkles className="size-3" />{[post.vehicle.name, post.vehicle.year, post.vehicle.brand, post.vehicle.model].filter(Boolean).join(" · ")}</Badge>}
      </CardContent>
