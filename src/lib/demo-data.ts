...
export const demoVehicles: Vehicle[] = [
  {
    id: "00000000-0000-0000-0000-000000000101", ownerId: demoProfile.id, nickname: "Mochi", make: "Mazda", model: "MX-5 RF", year: 2022, trim: "2.0 RF", color: "Snowflake White Pearl", description: "Small, light, and always ready for a sunrise run.", coverUrl: "https://images.unsplash.com/photo-1503736334956-4c8f8e92946d?auto=format&fit=crop&w=1200&q=85",
  },
  {
    id: "00000000-0000-0000-0000-000000000102", ownerId: demoProfile.id, nickname: "Blue", make: "Honda", model: "Civic Hatchback", year: 2020, trim: "Turbo RS", color: "Brilliant Sporty Blue", description: "The practical daily that still makes every commute fun.", coverUrl: "https://images.unsplash.com/photo-1590362891991-f776e747a588?auto=format&fit=crop&w=1200&q=85",
  },
];
...
export const demoPosts: Post[] = [
  ...
  {
    id: "00000000-0000-0000-0000-000000001002", body: "Sunday wash complete. Nothing dramatic—just good music, cold coffee, and two hours making the daily look new again.", photoUrl: "https://images.unsplash.com/photo-1507136566006-cfc505b114fc?auto=format&fit=crop&w=1400&q=85", createdAt: "2026-08-19T08:10:00.000Z", author: { username: "mint.motors", displayName: "Mint K.", avatarUrl: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=300&q=80" }, vehicle: { id: "00000000-0000-0000-0000-000000000103", nickname: "Milo", make: "Mini", model: "Cooper S", year: 2021 }, likesCount: 117, commentsCount: 8, likedByViewer: true,
  },
];
